            ...
            <div class="row gy-4">
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Name"
                                            name="name" id="name" value="{{ old('name',$admin->name) }}" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Address"
                                            name="address" id="address" value="{{ old('address',$admin->address) }}" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text" class="form-control" placeholder="+1 (555) 000-0000"
                                            name="phone" id="phone" value="{{ old('phone',$admin->phone) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-24 gy-3 align-items-center">
                ...
                <div class="col-md-3">
                    <div class="card p-0 mb-3">
                        ...
                        @php
    $imageUrl = $admin->getFirstMediaUrl('admin-image');
@endphp
                            ...
                            <div class="upload-image-wrapper d-flex align-items-center gap-3">
                                <div
                                    ...
                                    {{-- <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover"
                                        ...
                                        <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover"
                                        src="{{ $admin->getFirstMediaUrl('admin-image') ?? asset('images/default-user.png') }}"
                                        alt="image" >
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline1" name="status"
                                        class="form-check-input" value="1" {{ check_uncheck($admin->status, 1) }}>
                                    <label class="form-check-label" for="customRadioInline1">Active</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline2" name="status"
                                        class="form-check-input" value="0" {{ check_uncheck($admin->status, 0) }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="is_purchase_enabled1" name="is_purchase_enabled"
                                        class="form-check-input" value="1" {{ check_uncheck($admin->is_purchase_enabled, 1) }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="is_purchase_enabled2" name="is_purchase_enabled"
                                        class="form-check-input" value="0" {{ check_uncheck($admin->is_purchase_enabled, 0) }}>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            let newOption = new Option(response.coach.name, response.coach.name,true, true);
