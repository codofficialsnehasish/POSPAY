...
@section('contents')
    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Create Vendor</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Create Vendor</li>
            </ul>
        </div>
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Store ID"
                                            name="store_id" id="store_id" value="{{ old('store_id') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-24 gy-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Store Location"
                                            name="store_location" id="store_location" value="{{ old('store_location') }}"
                                            required>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <select name="branch[]" class="form-select select2 select2-multiple"
                                            ...
                                            @foreach ($coaches as $coach)
                                                <option value="{{ $coach->id }}"
                                                    @if (old('branch') == $coach->id) selected @endif>{{ $coach->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            {{-- <div class="row mb-24 gy-3 align-items-center inner-feilds">
                                <div class="row mb-4 stock-input-row">
                                    <div class="row mb-24 gy-3 align-items-center">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="icon-field">
                                                ...
                                                <input class="form-control" name="branch[0][name]" type="text"
                                                    placeholder="Batch No..." value="{{ old('branch_name') }}" required
                                                    autocomplete="off" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-1" style="display: flex;align-items: center !important;">
                                        <span class="text-danger stock-delete-btn" data-feather="trash-2"
                                            style="cursor: pointer;height:24px; width:24px;"></span>
                                    </div>
                                </div>
                            </div> --}}
