        ...
        <div class="card h-100 p-0 radius-12">
            <div
                ...
                @can('Vendor Create')
                    ...
                    <a href="{{ route('vendor.create') }}" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
                                    ...
                                    <td>
                                        ...
                                        @can('Vendor Delete')
                                            <a class="remove-item-btn bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle"
                                                ...
                                                data-url="{{ route('vendor.destroy', $user->id) }}" data-item="Route"
