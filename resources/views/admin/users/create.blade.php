    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Create User</li>
            </ul>
        </div>
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text"  class="form-control"
                                            placeholder="Enter First Name" name="first_name" id="first_name" value="{{ old('first_name') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-24 gy-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text"  class="form-control"
                                            placeholder="Enter Last Name" name="last_name" id="last_name" value="{{ old('last_name') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-24 gy-3 align-items-center">
                            ...
                            <div class="row mb-24 gy-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="+1 (555) 000-0000" name="phone" id="phone" value="{{ old('phone') }}" required>
                                    </div>
                                </div>
                            </div>

                            {{-- <div class="row mb-24 gy-3 align-items-center">
                                <label class="form-label mb-0 col-sm-2">Roles</label>
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        <span class="icon">
                                            <iconify-icon icon="solar:phone-calling-linear"></iconify-icon>
                                        </span>
                                        <select name="roles[]" class="form-select select2 select2-multiple" multiple="multiple" multiple data-placeholder="Choose ...">
                            ...
                            <div class="row mb-24 gy-3 align-items-center">
                                <label class="form-label mb-0 col-sm-2">Vendors</label>
                                <div class="col-sm-10">
                                    <div class="icon-field">
                             
                                        <select name="vendors[]" class="form-select select2 select2-multiple"
                            ...
                            <div class="row mb-24 gy-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="icon-field">
                                        ...
                                        <input type="password" name="password" id="password" value="{{ old('password') }}" required class="form-control" placeholder="*******">
                                    </div>
                                </div>
                            </div>
