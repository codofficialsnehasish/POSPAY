<ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->segment(3) == 'variation' ? 'active' : '' }}"  href="{{ route('products.variation',request()->segment(4)) }}" role="tab">
            <span class="d-none d-md-block">Variation</span>
            <span class="d-block d-md-none">
                <i class="mdi mdi-account h5"></i>
            </span>
        </a>
