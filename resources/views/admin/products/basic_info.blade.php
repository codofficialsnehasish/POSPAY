                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select name="hsncode_id" id="hsn_code" class="form-select select2 select2-single" data-placeholder="Choose ...">
                                                    <option value="" disabled selected>choose</option>
                                                    @foreach ($hsn_codes as $hsn_code)
                                                        <option value="{{ $hsn_code->id }}">{{ $hsn_code->hsncode }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            @if ($category->level == 0)
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        {{-- @endif --}}
                                                        <div class="form-check">
                                                            <input class="form-check-input radius-4 border border-neutral-400 category-checkbox"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {{-- <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="product_type1" name="product_type"
                                        class="form-check-input" value="simple" checked>
                            ...
                            <div class="mb-3" id="measureField">
                                ...
                                <input type="text" id="measure" name="measure" class="form-control" placeholder="Enter measure">
                            </div> --}}
                            
                            {{-- <div class="mb-3">
                                <label class="form-label mb-3 d-flex">Veg Or Non Veg</label>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline1" name="veg_non_veg"
                                        class="form-check-input" value="1" checked>
                                    <label class="form-check-label" for="customRadioInline1">Veg</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline2" name="veg_non_veg"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="is_available1" name="is_available"
                                        class="form-check-input" value="1" checked>
                                    <label class="form-check-label" for="is_available1">Avaliable</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="is_available2" name="is_available"
                                        class="form-check-input" value="0">
                                    <label class="form-check-label" for="is_available2">Not Avaliable</label>
                                </div>
                            </div>
                            {{--<div class="mb-3">
                                 <label class="form-label mb-3 d-flex">Special Product</label>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline1" name="is_special"
                                        class="form-check-input" value="1">
                                    <label class="form-check-label" for="customRadioInline1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline2" name="is_special"
