...
<div class="dashboard-main-body">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Edit Unit</h6>
        <ul class="d-flex align-items-center gap-2">
            ...
            <li>-</li>
            <li class="fw-medium">Edit Unit</li>
        </ul>
    </div>
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" value="{{ old('name',$unit->name)}}" class="form-control" placeholder="Enter Name">
                        </div>
                        <div class="col-12">
                            <label class="form-label">Short Name</label>
                            <input type="text" name="short_name" value="{{ old('short_name',$unit->short_name)}}" class="form-control" placeholder="Enter Short Name">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" id="customRadioInline1" name="is_visible" class="form-check-input" value="1" {{ check_uncheck($unit->is_active,1) }}>
                            <label class="form-check-label" for="customRadioInline1">Visible</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="customRadioInline2" name="is_visible" class="form-check-input" value="0" {{ check_uncheck($unit->is_active,0) }}>
