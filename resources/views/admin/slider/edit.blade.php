                ...
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control" rows="4" cols="50" placeholder="Enter a description...">{{ $slider->description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-0 mb-3">
                ...
                <div class="card-body p-24">
                    <div class="upload-image-wrapper d-flex align-items-center gap-3">
                        <div class="uploaded-img {{ is_have_image($slider->getFirstMediaUrl('slider')) }} position-relative h-120-px w-120-px border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50">
                            ...
                            <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover" src="{{ $slider->getFirstMediaUrl('slider') }}" alt="image">
                        </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" id="customRadioInline1" name="is_visible" class="form-check-input" value="1" {{ check_uncheck($slider->is_visible,1) }}>
                            <label class="form-check-label" for="customRadioInline1">Visible</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="customRadioInline2" name="is_visible" class="form-check-input" value="0" {{ check_uncheck($slider->is_visible,0) }}>
