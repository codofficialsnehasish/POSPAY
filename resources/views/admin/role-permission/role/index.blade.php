                        ...
                        <tbody>
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    @can('Asign Permission')
                                        <td><a href="{{ route('role.addPermissionToRole', ['roleId' => $role->id]) }}"
                                                class="btn btn-outline-success-600 radius-8 px-20 py-11">Asign Permission</a>
                                        </td>
                                    @endcan
                                        ...
                                        <td class="d-flex">
                                            @can('Role Edit')
                                                <button type="button"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#staticBackdropedit{{ $role->id }}"
                                            ...
                                            @can('Role Delete')
                                                <a class="remove-item-btn bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle"
                                                    ...
                                                    data-url="{{ route('role.destroy', ['roleId' => $role->id]) }}"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
            <div class="modal-content radius-16 bg-base">
                ...
                <div class="modal-body p-24">
                    <form action="{{ route('role.create') }}" method="post" class="row gy-3 needs-validation" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-12 mb-20">
